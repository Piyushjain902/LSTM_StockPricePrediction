...
Linear Regression provided the best classical ML performance. SVR performed poorly, likely due to hyperparameter settings or data scale.

LSTM Model
Architecture: 2 LSTM layers (64, 32 units), Dropout, Dense output.
